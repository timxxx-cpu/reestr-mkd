...
- `VITE_BFF_ENABLED`
- `VITE_BFF_BASE_URL`
- `VITE_LEGACY_ROLLBACK_ENABLED` (аварийный откат в legacy, по умолчанию `false`)
- `VITE_BFF_COMPOSITION_ENABLED`
- `VITE_BFF_FLOORS_ENABLED`
- `VITE_BFF_ENTRANCES_ENABLED`
- `VITE_BFF_UNITS_ENABLED`
- `VITE_BFF_MOP_ENABLED`
- `VITE_BFF_PARKING_ENABLED`
- `VITE_BFF_INTEGRATION_ENABLED`
- `VITE_BFF_CADASTRE_ENABLED`
- `VITE_BFF_PROJECT_INIT_ENABLED`
