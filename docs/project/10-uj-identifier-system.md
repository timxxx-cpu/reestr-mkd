...
**Таблицы реестров**:
- Инвентаризация квартир: показывает полный идентификатор `UJ000001-ZR01-EF042`
- Инвентаризация нежилых объектов: показывает `UJ000001-ZR01-EO001`
- Инвентаризация машиномест: показывает `UJ000001-ZP01-EP001`
