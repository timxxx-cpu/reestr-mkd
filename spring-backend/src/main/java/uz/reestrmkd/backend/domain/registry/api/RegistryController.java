...
public class RegistryController {
    ...
    public MapResponseDto syncParking(@PathVariable UUID floorId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
    ...
    public MapResponseDto upsertUnit(@RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
    ...
    public MapResponseDto batchUpsertUnits(@RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
    ...
    public MapResponseDto updateFloor(@PathVariable UUID floorId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
    ...
    public MapResponseDto updateFloorsBatch(@RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
    ...
    public MapResponseDto reconcileFloors(@PathVariable UUID blockId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
    ...
    public MapResponseDto reconcileEntrances(@PathVariable UUID blockId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
   ...
   @PutMapping("/blocks/{blockId}/entrance-matrix/cell")
    public MapResponseDto upsertCell(@PathVariable UUID blockId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
        ...
        return MapResponseDto.of(rows.isEmpty() ? Map.of("ok", true) : rows.getFirst()); 
    }

   @PutMapping("/blocks/{blockId}/entrance-matrix/batch")
    public MapResponseDto upsertMatrixBatch(@PathVariable UUID blockId, @RequestBody(required = false) MapPayloadDto payload, @CurrentUser ActorPrincipal actor) {
        requirePolicy(actor, "registry", "mutate", "Role cannot modify registry data");
        Map<String, Object> body = payload == null || payload.data() == null ? Map.of() : payload.data();
