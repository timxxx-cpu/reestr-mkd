...
export const WORKFLOW_STAGES = {
  // Этап 1: До инвентаризации подъездов (шаг 6) включительно
  1: { lastStepIndex: 6, label: 'Этап 1: Инвентаризация' },

  // Этап 2: Нумерация, МОП, Паркинг (до шага 9)
  2: { lastStepIndex: 9, label: 'Этап 2: Конфигурация' },

  // Этап 3: Реестры (до шага 12)
  3: { lastStepIndex: 12, label: 'Этап 3: Реестры' },

  // Этап 4: Финал (до конца списка)
  4: { lastStepIndex: 17, label: 'Финал: Интеграция' },
};
...
export const STEPS_CONFIG = [
  ...
  },
  {
    ...
    description: 'Связи подвалов и обслуживаемых блоков',
    icon: Warehouse,
  },
  {
    id: 'floors',
