...
export const buildFloorList = (building, currentBlock, buildingDetails = {}) => {
    ...
    const effectiveDetailsKey = (currentBlock.id === 'main' && (building.category === 'parking_separate' || building.category === 'infrastructure'))
        ? `${building.id}_main`
        : detailsKey;
    ...
    const isInfrastructure = building.category === 'infrastructure' || currentBlock.originalType === 'infrastructure';

    const isUndergroundParking = isParking && (
