                     ...
                     <div className="space-y-6 mt-4">
                         ...
                         <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-3">
                                <button disabled={isReadOnly} onClick={() => decrement('inputs', 1)} className="w-10 h-10 bg-white border border-slate-200 rounded-xl font-bold hover:bg-slate-50 disabled:opacity-50 transition-colors shadow-sm">-</button>
                                <span className="font-bold text-2xl w-10 text-center text-slate-700">{renderCounterValue(details.inputs)}</span>
                                <button disabled={isReadOnly} onClick={() => increment('inputs', 10)} className="w-10 h-10 bg-white border border-slate-200 rounded-xl font-bold hover:bg-slate-50 disabled:opacity-50 transition-colors shadow-sm">+</button>
                            </div>
                         </div>
                     </div>
                </Card>
