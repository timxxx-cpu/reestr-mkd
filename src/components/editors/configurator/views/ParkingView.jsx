        ...
        return (
            <div className="flex justify-center mt-10">
                <Card className="p-12 border-dashed flex flex-col items-center justify-center text-center max-w-lg w-full bg-slate-50/50">
                    <div className="p-6 bg-slate-100 rounded-full text-slate-300 mb-6"><Car size={64} /></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-6 items-start">
                <Card className="p-8 shadow-md border-t-4 border-t-amber-500">
                    ...
                    <div className="space-y-6 mt-6">
                        <Label>Выберите вариант исполнения <span className="text-red-500">*</span></Label>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                <Warehouse size={32} /><span className="font-bold">Навесы</span>
                            </button>
                            <button 
                                disabled={isReadOnly} 
                            ...
                            >
                                <Store size={32} /><span className="font-bold">Боксы</span>
                            </button>
                        </div>
                        {errors.lightStructureType && <span className="text-[10px] text-red-500 font-bold block mt-1 bg-red-50 p-2 rounded border border-red-100 text-center">Выберите тип конструкции</span>}
                    </div>
                </Card>
