...
import { useReadOnly } from '../../../ui/UIKit'; // TabButton убрал из импорта, сделаем кастомный тут
                    ...
                    <div className="xl:col-span-6 space-y-6">
                        ...
                        {(isResidentialBlock && !isCommercialValid) && (
                            <div className="text-[10px] text-red-500 bg-red-50 p-3 rounded-xl text-center border border-red-100 font-medium">
                                Внимание: Укажите коммерческие этажи хотя бы в одном жилом блоке (требование паспорта)
                            </div>
                        )}
                    </div>
