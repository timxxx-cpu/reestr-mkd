...
export const StatBadge = ({ label, value, subLabel, color }) => (
  <div
    className={`p-3 rounded-xl border ${color} flex flex-col items-center justify-center text-center w-full`}
  >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-8 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div>
            ...
            <h3 id="registry-modal-title" className="text-2xl font-black text-slate-800">
              {title}
            </h3>
          </div>
          <button
      ...
      tabIndex={0}
        ...
        {/* Stats Panel (ТЭП) */}
        <div className="p-6 bg-white border-b border-slate-100">{statsContent}</div>
