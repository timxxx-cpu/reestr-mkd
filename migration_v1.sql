...
-- Полный hard-reset схемы public: таблицы, представления, последовательности,
-- функции и триггеры удаляются каскадно.
DO $$
DECLARE
    obj RECORD;
BEGIN
...
-- Описание: Нормализованное хранение матрицы "Инвентаризация подъездов".
